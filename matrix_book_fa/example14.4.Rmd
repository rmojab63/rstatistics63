...
```{r fig_cointegration1, fig.align='center', fig.cap="", fig.width=5, fig.height=3}
...
```{r fig_cointegration2, fig.align='center', fig.cap="", fig.width=5, fig.height=3}
par <- par(mar = c(4, 4, 2, 2) + 0.1)
...
```{r fig_cointegration22, fig.align='center', fig.cap="", fig.width=5, fig.height=3}
par <- par(mar = c(4, 4, 2, 2) + 0.1)
dyn.sim.plot(res, beta)
```
...
```{r fig_cointegration21, fig.align='center', fig.cap="", fig.width=5, fig.height=3}
par <- par(mar = c(4, 4, 2, 2) + 0.1)
dyn.sim.plot(res, beta, "topright") 
```

...
```{r} 
plot.field <- function(u = function(x, y) {
  y
},
v = function(x, y) {
  -x - 3 * y
...
```{r fig_differential2_neg_diff, fig.align='center', fig.cap="", fig.width=3, fig.height=3}
...
```{r fig_differential2_pos_diff, fig.align='center', fig.cap="", fig.width=3, fig.height=3}
par <- par(mar = c(2, 2, 2, 2) + 0.1)
plot.field(
  u = function(x, y) {
    -y
...
```{r fig_differential2_neg_pos, fig.align='center', fig.cap="", fig.width=3, fig.height=3}
par <- par(mar = c(2, 2, 2, 2) + 0.1)
d <- plot.field(
  u = function(x, y) {
    x + 2 * y
...
```{r fig_differential2_neg_eq, fig.align='center', fig.cap="", fig.width=3, fig.height=3}
par <- par(mar = c(2, 2, 2, 2) + 0.1)
plot.field(
  u = function(x, y) {
    -x
...
```{r fig_differential2_pos_eq, fig.align='center', fig.cap="", fig.width=3, fig.height=3}
par <- par(mar = c(2, 2, 2, 2) + 0.1)
plot.field(
  u = function(x, y) {
    x
...
```{r fig_differential2_neg_real, fig.align='center', fig.cap="", fig.width=3, fig.height=3}
par <- par(mar = c(2, 2, 2, 2) + 0.1)
plot.field(
  u = function(x, y) {
    -x - 2 * y
...
```{r fig_differential2_pos_real, fig.align='center', fig.cap="", fig.width=3, fig.height=3}
par <- par(mar = c(2, 2, 2, 2) + 0.1)
plot.field(
  u = function(x, y) {
    x + 2 * y
...
```{r fig_differential2_zero_real, fig.align='center', fig.cap="", fig.width=3, fig.height=3}
par <- par(mar = c(2, 2, 2, 2) + 0.1)
plot.field(
  u = function(x, y) {
    y

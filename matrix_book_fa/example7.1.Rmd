...
print(A)
```
```{r fig_linear_form_rotation, fig.align='center', fig.cap="", fig.width=3, fig.height=3, echo=-1}
...
print(A)
```
```{r fig_linear_form_reflection, fig.align='center', fig.cap="", fig.width=3, fig.height=3, echo=-1}
par <- par(mar = c(2, 2, 2, 2) + 0.1)
plot.ellipse(
...
print(A)
```
```{r fig_linear_form_scale, fig.align='center', fig.cap="", fig.width=3, fig.height=3, echo=-1}
par <- par(mar = c(2, 2, 2, 2) + 0.1)
plot.ellipse(
  axisXY = axisXY, ylim = c(0, 5),
  xlim = c(0, 5), lwd = 2

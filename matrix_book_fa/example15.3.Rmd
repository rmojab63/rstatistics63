...
```{r fig_differential_stochastic, fig.align='center', fig.cap="", fig.width=5, fig.height=3,warning=FALSE}
library(ggplot2) 
theme_set(theme_bw())
...
# Add the legend
p <- p + 
  scale_color_manual(values = c("Path" = "lightgray", "Average" = "red", "AnalyticalIto" = "blue",
                                "AnalyticalStra" = "orange", One = "black"),
                     labels = c("Path" = "دیگر تحقق‌ها",
                                "One" = "یک تحقق",
                                "Average" = "متوسط",

...
@
<<echo=FALSE>>=
format_warnings_errors(matrix(c(1:4), nrow = 1, ncol = 2), chars_per_line = 41)
@
...
@
در خط اول، ماتریسی از اعداد مختلط و در خط دوم، ماتریسی از نوع بولی ساخته می‌شود (نتایج گزارش نشده است). اکنون در ابتدا، ماتریسی با درایه‌های حروف می‌سازیم و سپس آن را به ماتریسی حقیقی تبدیل می‌کنیم. کد زیر را ببینید:
<<>>=
...
A
@
حالت کلی پس از معرفی ماتریس‌های افراز‌شده در بخش ۱.۸ بحث می‌شود. [مثال ۲.۲](\example2.2) را نیز ببینید.

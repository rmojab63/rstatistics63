...
در شرط از علامت
`&&`
استفاده شده و به این معنی است که هر دو شرط داده‌شده با یکدیگر باید برقرار باشند. همچنین، تابع `t()` ترانهادهٔ ماتریس را محاسبه می‌کند (نگاه کنید به: بخش ۲.۱ کتاب). به‌عنوان تمرین، کدی برای بررسی متقارن‌بودن یک ماتریس بنویسید.
